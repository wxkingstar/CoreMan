export default {
  ...
  myFeishu: {
    ...
    unselected: '未選択',
    levels: {"messages_readonly": "1 · メッセージの読み取りのみ", "all_except_send": "2 · 全権限（メッセージ送信を除く）", "all": "3 · 全権限（メッセージ送信を含む）", "legacy_readonly": "従来の読み取り専用認証"},
    ...
    requestHint: "レベル 1 はメッセージの読み取りのみです。レベル 2 はアプリで有効なユーザー権限すべて（書き込みを含み、メッセージ送信を除く）です。レベル 3 は送信も許可します。認証後は「{command}」など自然に質問でき、コマンド接頭辞は不要です。現在は Claude ランタイムのみ対応しています。",
  "title": "マイ飛書",
  "intro": "AI 社員ごとの飛書個人データへのアクセス権限を管理します。",
  "connectHint": "飛書の個別チャットで AI 社員に「{command}」と送り、1・2・3 でレベルを選択してから認証リンクを開いてください。",
