...
const skillEditorEn = {
  ...
  syncSkipped: '{skipped} deleted skill(s) were not imported again.',
  deleteConfirm: 'Delete "{name}" from the catalog? Syncing its source will not import it again; existing install and approval history is kept. If an AI employee still uses or is requesting it, stop or withdraw it in that employee’s skills first. To restore it, create a skill with the same name.',
  deleted: 'Deleted',
