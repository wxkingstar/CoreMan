...
export const skills = {
  ...
  sourceSync: (row: Source) => call<{ created: number; updated: number; unchanged: number; skipped: number }>(http.post(`${root}/skill-sources/${row.id}/sync`, {}, { ...match(row.version), timeout: 210000 })),
